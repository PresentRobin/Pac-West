       ...
       // private SpriteFont _font = default;
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (_timer > 0.8f)
            {
                ...
                _sprites.Add(new Obstacle(Content.Load<Texture2D>("eni")));
                _sprites.Add(new Obstacle(Content.Load<Texture2D>("eni2")));
                _sprites.Add(new Obstacle(Content.Load<Texture2D>("eni3")));
            }
